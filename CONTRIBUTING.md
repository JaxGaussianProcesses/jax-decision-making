...
Thanks for your interest in contributing to `jax-decision-making`! We welcome contributions from the community to help improve the project. Please follow the guidelines below to ensure a smooth contribution process.
...
1. **Fork the Repository**: Start by forking the `jax-decision-making` repository on GitHub to your own account.
...
9. **Push Changes**: Push your changes to your forked repository:
   ...
   ```
10. **Create a Pull Request**: Open a pull request in the [original `jax-decision-making` repository](https://github.com/JaxGaussianProcesses/jax-decision-making).
